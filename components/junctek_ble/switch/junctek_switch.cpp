...
static const char *const TAG = "junctek_ble.switch";

void JunctekSwitch::dump_config() { LOG_SWITCH("", "JkBmsBle Switch", this); }
void JunctekSwitch::write_state(bool state) {
