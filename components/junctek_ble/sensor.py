...
from esphome.const import CONF_ID, CONF_VOLTAGE, UNIT_VOLT, ICON_FLASH, DEVICE_CLASS_VOLTAGE
...
CONFIG_SCHEMA = cv.Schema({
    ...
    cv.Required(CONF_VOLTAGE): sensor.sensor_schema(UNIT_VOLT, ICON_FLASH, 2, DEVICE_CLASS_VOLTAGE),
